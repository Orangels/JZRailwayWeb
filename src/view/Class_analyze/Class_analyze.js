...
import { mean_data, person, state_arr, summary_class_default, state_default } from '../../common/data/person'
...
export default class Teacher_analyze extends React.Component {
    ...
    _generate_report(){
        ...
        let upload_data = {...this.state, select_tab:'Data_repoty_tab_2', compare_mode: compare_mode}
    ...
    //             name: `${this.state.main_person.grade+1}年${this.state.main_person.classNum+1}班`,
    ...
    //                 name: `${this.state.compare_persons[compare_person_index]['grade']+1}年${this.state.compare_persons[compare_person_index]['classNum']+1}班`,
    //                 "英语": mean_data[index][this.state.compare_persons[compare_person_index]['person']*jump_flag+0],
    //                 "语文": mean_data[index][this.state.compare_persons[compare_person_index]['person']*jump_flag+1],
    //                 "数学": mean_data[index][this.state.compare_persons[compare_person_index]['person']*jump_flag+2],
    //                 "物理": mean_data[index][this.state.compare_persons[compare_person_index]['person']*jump_flag+3],
    //                 "化学": mean_data[index][this.state.compare_persons[compare_person_index]['person']*jump_flag+4],
    //                 "生物": mean_data[index][this.state.compare_persons[compare_person_index]['person']*jump_flag+5],
    //                 "地理": mean_data[index][this.state.compare_persons[compare_person_index]['person']*jump_flag+6],
    //             })
    //         }
    //
    //     }
    ...
    //                 state_type:`${this.state.main_person.grade+1}年${this.state.main_person.classNum+1}班`,
    ...
    //                     state_type:`${this.state.compare_persons[compare_person_index]['grade']+1}年${this.state.compare_persons[compare_person_index]['classNum']+1}班`,
    ...
    _updateSummary(){
        ...
        if (hasMain_person){
            ...
            let person_name = person[this.state.main_person['person']]['name']
            console.log(person_name)
            let name = `${this.state.main_person.grade+1}年${this.state.main_person.classNum+1}班`
            let state_name = state_arr[this.state.show_mode]
            // let state_total = this.state.data_2.total_state
            let state_total = this.state.data_2.total_state[state_name]
            console.log(this.state.data_2.total_state)
            ...
            let summary_str = `${this.state.main_person['grade']+1}年${this.state.main_person['classNum']+1}班的${state_name}是${Math.floor(state)},${summary_class_default[this.state.show_mode][summary_num]}`

            summary.push(summary_str)

            for ( let compare_person_index in this.state.compare_persons) {
                if (Object.keys(this.state.compare_persons[compare_person_index]).length > 0) {
                    let person_name = person[this.state.compare_persons[compare_person_index]['person']]['name']
                    console.log(person_name)
                    let name = `${this.state.compare_persons[compare_person_index].grade+1}年${this.state.compare_persons[compare_person_index].classNum+1}班`
                    let state_name = state_arr[this.state.show_mode]
                    // let state_total = this.state.data_2.total_state
                    let state_total = this.state.data_2.total_state[state_name]
                    console.log(state_total)
                    ...
                    let summary_str = `${this.state.compare_persons[compare_person_index]['grade']+1}年${this.state.compare_persons[compare_person_index]['classNum']+1}班的${state_name}是${Math.floor(state)},${summary_class_default[this.state.show_mode][summary_num]}`
    ...
    render() {
        return (
            <Template classTag={'Class'} current_page={2} history={this.props.history}
