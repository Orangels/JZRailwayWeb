    ...
    _minusPerson(num, e){
        ...
        if (this.state.selectPersons.length > 0){
            ...
            this.setState({
                ...
                for (let i in this.RotateCard){
                    this.RotateCard[i]._rotateTest();
                }
                console.log(this.state.selectPersons)
                                        ...
                                        <div className="swiper-slide"
                                            ...
                                            >
                                                <PersonalInformation key={`personInf_${index}`}
                                                                     ...
                                                                     style={{width:'100%', height:'100%'}}  onClick={this._click.bind(this,0,index)}
                                                ...
                                                <SelectPerson
                                                    ...
                                                    selectPerson={selectPerson}
                                                    _cancelClick={this._cancelClick.bind(this,1,index)}/>
                                            </RotateCard>
                                        </div>
                                    </div>
                                )
