...
export default class PersonalInformation extends React.Component {
    ...
    render() {
        ...
        let person_icon = show_person_flag ? `url(${person[this.state.selectPerson.person].img}) center center / 100% 100% no-repeat` : null
        let person_name = show_person_flag ? person[this.state.selectPerson.person].name : '-'
                ...
                <div style={style.person}>
                    ...
                    <div style={style.personInformation}>
                        <div style={{display:'flex', flexDirection:'column',marginLeft:20*screen_scale_width}}
                            ...
                            <span style={{...style.persopnText, ...{marginTop: 0}}}>姓名 : {person_name}</span>
