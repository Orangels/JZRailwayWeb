...
export default class SelectPerson extends React.Component {
    ...
    componentDidMount() {
        ...
        console.log(this.props.selectPerson)
    ...
    componentWillReceiveProps(nextProps, nextContext) {
        ...
        selectPerson = selectPerson || this.state
        console.log(nextProps.selectPerson)
        this.setState({
            ...selectPerson,
        },()=>{
            this.defaultState = Object.assign({},this.state)
    ...
    _confirmClick(e){
        ...
        let has_classNum = this.state.hasOwnProperty('classNum')
        let has_grade = this.state.hasOwnProperty('grade')
        if (has_classNum && has_grade ){
            this.setState({
                person:this.state.classNum + this.state.grade
            },()=>{
                this.defaultState = Object.assign({},this.state)
                //TODO 这里做传值处理
