...
draw() {
  ...
  if (this.nowRange <= this.state.rangeValue) {
    this.nowRange += 1;
  }
  if (this.nowRange > this.state.rangeValue) {
    this.nowRange -= 1;
...
drawText(ctx){
  ...
  ctx.fillText(this.state.showText, r, r);
  ctx.fillText(this.state.showText_1, r, r + size);
